...
<div class="row">
	<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
		<h3>Listado de Categorías <a href="categoria/create"><button class="btn btn-success">Nuevo</button></a><a href="{{url('reportecategorias')}}"target="black"><button class="btn btn-info">Reporte</button></a></h3>
